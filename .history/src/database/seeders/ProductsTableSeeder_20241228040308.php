...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => Storage::files('app/public/images/kiwi.png'),
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => Storage::files('app/public/images/strawberry.png'),
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => Storage::files('app/public/images/orange.png'),
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => Storage::url('watermelon.png'),
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => Storage::url('pineapple.png'),
